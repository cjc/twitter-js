...
module.exports = function (api_key, api_secret, redirect) {
  ...
  // PUBLIC
  client.apiCall = function (req, method, path, params, callback) {
    var token = {oauth_token: req.session.auth.twitter_access_token, oauth_token_secret: req.session.auth.twitter_access_token_secret };
  ...
  client.getAccessToken = function (req, callback) {
    ...
    oAuth.getOAuthAccessToken(
      ...
      function (error, oauth_token, oauth_token_secret, additionalParameters) {
        if (error) {
          ...
          req.session.auth.twitter_access_token = oauth_token;
          req.session.auth.twitter_access_token_secret = oauth_token_secret;
